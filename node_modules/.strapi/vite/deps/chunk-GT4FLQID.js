...
var admin2 = {
  register(app) {
    app.addMenuLink({
      ...
      Component: () => import("./App-AVOWIWL6.js").then((mod) => ({
        default: mod.Upload
      })),
      position: 4
    });
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled("cms-content-releases")) {
      app.addMenuLink({
        ...
        Component: () => import("./App-OR7VFHKY.js").then((mod) => ({
          default: mod.App
        })),
      ...
      app.widgets.register([
        {
          ...
          component: async () => {
            const { AssignedWidget } = await import("./Widgets-UCQCSLAR.js");
...
//# sourceMappingURL=chunk-GT4FLQID.js.map
